...
namespace NethTest
{
    ...
    public class ERC20Sender
    {
        ...
        private static string ContractAddress { get; set; } = "0x6719c6d781ca9a87eef9ca6959431a7da5f5301a"; //stays static for CHIMERA
        ...
        public ERC20Sender(string From, string FromPvtKey, string To, int Qty)
        {
            this.FromAddr = From;
